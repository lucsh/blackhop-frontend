...
$scope.alquiler={}
        ...
        $http.get('http://blackhop.api.dessin.com.ar/api/pos/caja/calendarioalquileres',{
            ...
            */
            ...
            for (var i = 0; i <  $scope.alquilables.length; i++) {  
                $scope.alquilables[i].dias[0].fecha = $scope.primerDiaDeEstaSamana.clone();
                $scope.alquilables[i].dias[0].diaFecha = $scope.primerDiaDeEstaSamana.clone().locale('es').format('DD');
                $scope.alquilables[i].dias[0].fechaMysql = $scope.primerDiaDeEstaSamana.clone().locale('es').format('YYYY-MM-DD');
    ...
    alquilable.dias[dia-1].claseAnterior=alquilable.dias[dia-1].hover;
        ...
        $scope.traerCalendario('comienzo');
...
function terminarVentaCtrl ($q,$http,$scope,$log,$uibModalInstance,SweetAlert,$uibModal,WizardHandler,clienteSeleccionado,resumen){
...
function imprimirAlquilerCtrl($scope, $sanitize, $log, $uibModalInstance, alquiler) { //mariobross
...
function imprimirCuponCtrl ($scope,$sanitize,$log,$uibModalInstance,cupon){
        ...
        var printData = [
        {
            ...
            +'    <div id="printBody">'
            +'        <div>'
            +'            <img widht="30" height="auto" alt="image" src=" data:image/png;base64,">'
            +'        </div>'
            +'        <p style="font-family: Impact, Charcoal, sans-serif; margin:0 24px; padding:0; font-size: 30px;font-weight: 600;">'
            +           $scope.cupon.turnoNumero 
            +'        </p>'
            +'        <p style="font-family: Impact, Charcoal, sans-serif;margin:0 20px; padding:0; font-size: 22 px;font-weight: 600;">'
            +           $scope.cupon.litros + ' '+litroPlural
            +'        </p>'
            +'        <div>'
            +''   
            +         '<img src="'+$scope.imagenSRC+'">'
            +'        <p style="font-family: Arial, sans-serif;margin:0 13px; padding:0;font-size: 12px;font-weight: 400;">'
            +           $scope.cupon.codigo
            +'        </p>'
            +'        </div>'
            +'        <p style="font-family: Arial, sans-serif;margin:0 13px; padding:0;font-size: 12px;font-weight: 400;">'
            ...
            +'        </p>'
            +'        <span style="font-family: Tahoma, sans-serif;margin:0 11px; padding:0;font-size: 10px;font-weight: 600;">Hasta:</span>'
            +'        <span style="font-family: Impact, Charcoal, sans-serif;margin:0 0px; padding:0;font-size: 12px;font-weight: 400;line-height: 0px;">'+$scope.vencimiento+'</>'
            +'   </div>'
            +'    <hr>'
            +'</html>'
        }
