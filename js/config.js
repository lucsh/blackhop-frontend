 ...
 *
 */
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, $authProvider, IdleProvider, KeepaliveProvider) {
    ...
    $authProvider.loginUrl = 'http://blackhop-dessin1.rhcloud.com/api/v1/authenticate';
...
*/
            ...
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([                        
                        ...
                        {
                            name: 'truncate',
                            files: ['js/plugins/angular-truncate/truncate.js']
                        },
                        {
                            name: 'xeditable',
                            files: ['css/plugins/angular-xeditable/xeditable.css','js/plugins/angular-xeditable/xeditable.min.js']
                        },
                        {
                            files: ['js/plugins/moment/moment.min.js']
                        },
        ...
        .state('login_lista', {
            url: "/login_lista",
            templateUrl: "views/login_lista.html",
            data: { pageTitle: 'Login', specialClass: 'gray-bg' },
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
        ...
        .state('pos', {
            abstract: true,
            url: "/pos",
            templateUrl: "views/common/pos-content.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
        ...
        .state('pos.point_of_sale', {
            url: "/point_of_sale",
            templateUrl: "views/point_of_sale.html",
            resolve: {
                loadPlugin: function ($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                        ...
                        {
                            name: 'io-barcode',
                            files: ['js/plugins/angular-io-barcode/angular-io-barcode.min.js']
                        },
        ...
        .state('pos.point_of_sale_barra', {
            url: "/point_of_sale_barra",
            templateUrl: "views/point_of_sale_barra.html",
            data: { 
                pageTitle: 'POS - Barra', 
                specialClass: 'canvas-menu' ,
                autorized: ['Admin','User']
